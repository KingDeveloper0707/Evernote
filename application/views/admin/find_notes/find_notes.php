        ...
        <div class="card">
          ...
          <ul id="myUL">
            ...
            <li><span class="caret_top" id="tree_companies_wrap">COMPANY</span>
              ...
              <?php foreach ($all_companies as $my_data){
                  
                    ?>

                    <li ><?php echo $my_data['company']; ?></li>
            ...
            <li><span class="caret_top" id="tree_expertise_wrap">EXPERTISE</span>
              <ul class="nested" id="tree_expertise">
              <?php foreach ($all_expertise as $my_data){
                  
                    ?>

                    <li  ><?php echo $my_data['expertise']; ?></li>
            ...
            <li><span class="caret_top" id="tree_positions_wrap">POSITION</span>
              <ul class="nested" id="tree_positions">
              <?php foreach ($all_positions as $my_data){
                  
                    ?>

                    <li  ><?php echo $my_data['position_title']; ?></li>
