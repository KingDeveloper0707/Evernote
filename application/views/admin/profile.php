...
<script>
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res['new_company_name'] != "") {
                        ...
                        $("tr.selected_tr").find(".note_left_tags_hide .company_list_wrap").append(add_tag);
                    ...
                    if (res['new_notetype_name'] != "") {
                        ...
                        $("tr.selected_tr").find(".note_left_tags_hide .notetype_list").append(add_tag);
        ...
        $(document).on('dblclick', '#show_note_datatable tbody tr.selected_tr', function() {
            ...
            var replaced_companies = $("#show_note_datatable tbody tr.selected_tr").find(".note_left_tags_hide .company_list_wrap").html();
            $(".right_title_companies").html(replaced_companies);


            var replaced_notetypes = $("#show_note_datatable tbody tr.selected_tr").find(".note_left_tags_hide .notetype_list_wrap").html();
            ...
            $(".right_title_name").text($("#show_note_datatable tbody tr.selected_tr").find(".user_name_hide").text());
            ...
            bootbox.confirm({
                ...
                callback: function(result) {
                    ...
                    if (result) {
                        ...
                        var ajax_url = '<?php echo base_url(); ?>admin/profile/delete_tag_one';
            ...
            bootbox.confirm({
                ...
                callback: function(result) {
                    ...
                    if (result) {
                        ...
                        var ajax_url = '<?php echo base_url(); ?>admin/profile/delete_company_one';
            ...
            bootbox.confirm({
                ...
                callback: function(result) {
                    ...
                    if (result) {
                        ...
                        var ajax_url = '<?php echo base_url(); ?>admin/profile/delete_notetype_one';
